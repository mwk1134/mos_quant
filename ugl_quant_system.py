...
class UGLQuantTrader(SOXLQuantTrader):
    """UGL 전용 트레이더 (UGL 티커 사용)"""
...
def main():
    ...
    # 트레이더 초기화 (기본 UGL 로직 사용)
    trader = UGLQuantTrader(initial_capital)
